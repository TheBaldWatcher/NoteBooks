...
do_build()
{
    ...
    # 编译安装目录
    ARCH_BUILD_DIR=$work_dir/build/mtphone/$BUILD_ARCH
    ...
    if [ "$BUILD_TYPE" == "Release" ]; then
        NOSYMBOL_DIR=${work_dir}/libs_without_symbol/mtphone/${BUILD_ARCH}
        SYMBOL_DIR=${work_dir}/libs_with_symbol/mtphone/${BUILD_ARCH}/
